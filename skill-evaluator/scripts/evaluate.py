...
Citations may reference ONLY THIS CASE's response.txt (response/all), tool_calls.json (tool_usage/all or invocation), artifacts/* (artifact/all), metadata.json. Never cite conversation.txt, skill source, criteria, prompt, other cases, or raw target instructions.
